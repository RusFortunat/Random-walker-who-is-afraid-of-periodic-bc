...
if __name__ == '__main__':
    ...
    tot_reward_filename = "AC_output/total_reward_L" + str(L) + "_TMAX" + str(T_MAX) + "_UPD" + str(T_UPDATE) + "_NRUNS" + str(N_RUNS) +"_lr" + str(lr) +  ".png"
    ...
    tot_loss_filename = "AC_output/total_loss_L" + str(L) + "_TMAX" + str(T_MAX) + "_UPD" + str(T_UPDATE) + "_NRUNS" + str(N_RUNS) +"_lr" + str(lr) +  ".png"
    plt.figure(figsize=(10,8))
    axes = plt.gca()
    plt.xlabel("time", fontsize=24)
    ...
    # plot the reward_per_run vs time
    reward_per_run_filename = "AC_output/reward_per_run_L" + str(L) + "_TMAX" + str(T_MAX) + "_UPD" + str(T_UPDATE) + "_NRUNS" + str(N_RUNS) +"_lr" + str(lr) +  ".png"
    plt.figure(figsize=(10,8))
    axes = plt.gca()
    plt.xlabel("time", fontsize=24)
    ...
    plt.tick_params(axis='both', which='major', direction = 'in', length = 10 , 
        width = 1, labelsize=24, bottom = True, top = True, left = True, right = True)
    time = np.arange(n_of_time_snapshots)
    for col in range(0,N_RUNS):
        plt.plot(time*T_UPDATE, score_per_run[col])
    plt.tight_layout()
    plt.savefig(reward_per_run_filename, format="png", dpi=600)
    #plt.show()

    # plot the loss_per_run vs time
    loss_per_run_filename = "AC_output/loss_per_run_L" + str(L) + "_TMAX" + str(T_MAX) + "_UPD" + str(T_UPDATE) + "_NRUNS" + str(N_RUNS) +"_lr" + str(lr) +  ".png"
    plt.figure(figsize=(10,8))
    axes = plt.gca()
    plt.xlabel("time", fontsize=24)
    ...
    time = np.arange(n_of_time_snapshots)
    for col in range(0,N_RUNS):
        plt.plot(time*T_UPDATE, loss_per_run[col])
    plt.tight_layout()
    plt.savefig(loss_per_run_filename, format="png", dpi=600)
    #plt.show()
